<%-- 
    Document   : formulario_personal_edit.jsp
    Created on : 2/12/2021, 11:58:26 AM
    Author     : duvan
--%>
                        ...
                        <div class="col-md-9">
                            <div class="table-responsive">
                                <div class="container">
                                    <main>
                                        <div>
                                            <h2 class="tituloV mb-3">Editar Personal</h2>
                                        </div>
                                        <form action="./srvPersonal" method="POST" id="form2">
                                            <%
                                                UsuarioDAO dao = new UsuarioDAO();
                                                int id = Integer.parseInt((String) request.getAttribute("ideper"));
                                                usuario u = (usuario) dao.list(id);
                                            %>
                                            <input type="hidden" name="txt_id" value="<%= u.getId_usuario()%>" />
                                            ...
                                            <select class="form-control label1 mb-3" value="" name="cargo" >
                                            ...
                                            <input type="submit" name="accion" value="Actualizar" class="btn btn-danger btn-block"/>
                                        </form>
